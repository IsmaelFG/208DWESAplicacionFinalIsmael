...
<a class="navbar-brand text-white">Mostrar Vehiculo</a>
</div>
</nav>
                ...
                <tr>
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="matricula"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['matricula']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="modelo"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['modelo']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="fechaCompra"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['fechaCompra']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="numPuertas"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['numPuertas']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>                                                     
                        <input class="d-flex justify-content-start" type="text" name="color" 
                               value="<?php echo ($_SESSION['vehiculoMostrar']['color']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="valor"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['valor']); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex justify-content-start">
                    ...
                    <td>
                        <input class="d-flex justify-content-start" type="text" name="fechaBaja"
                               value="<?php echo ($_SESSION['vehiculoMostrar']['fechaBaja']); ?>" disabled>
                    </td>
                </tr>
            </tbody>
        </table>
